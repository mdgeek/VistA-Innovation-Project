...
/**
 * Unit tests for Chief Complaint
 */
public class rpmsChiefComplaintTest extends CommonTest {
    
    private static final Log log = LogFactory.getLog(rpmsChiefComplaintTest.class);
