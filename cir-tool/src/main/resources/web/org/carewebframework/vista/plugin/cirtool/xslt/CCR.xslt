...
<xsl:stylesheet exclude-result-prefixes="a date str" version="1.0" xmlns:a="urn:astm-org:CCR" xmlns:date="http://exslt.org/dates-and-times" xmlns:str="http://exslt.org/strings" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:decimal-format decimal-separator="." grouping-separator="," infinity="Infinity" minus-sign="-" NaN="NaN" percent="%"
                              ...
                              <tbody>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Alerts/a:Alert">
                                  <tr>
                                    ...
                                    <td>
                                      <xsl:apply-templates select="a:Type/a:Code"/>
                                    </td>
                                    <td>
                                      <table class="internal">
                                        <tbody>
                                    ...
                                    <td>
                                      ...
                                      <!-- MSC: look for extra coding -->
                                      <xsl:if test="a:Agent/a:Products/a:Product/a:Product/a:ProductName/a:Code">
                                        <xsl:apply-templates select="a:Agent/a:Products/a:Product/a:Product/a:ProductName/a:Code"/>
                                      </xsl:if>
                                    </td>
                                    <td>
                              ...
                              <tbody>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Immunizations/a:Immunization">
                                  <tr>
                                    ...
                                    <td>
                                      <xsl:value-of select="a:Product/a:Manufacturer/a:ActorRole/a:Text"/>
                                    </td>
                                    <td>
                                      <a>
                                        <xsl:attribute name="href">
                              ...
                              <tbody>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Results/a:Result[a:Test/a:TestResult/a:Value!='']">
                                  <tr>
                                    ...
                                    <td>
                                      <xsl:value-of select="a:Test/a:NormalResult/a:Normal/a:Value"/>
                                      <xsl:text xml:space="preserve"> </xsl:text>
                                      <xsl:value-of select="a:Test/a:NormalResult/a:Normal/a:Units/a:Unit"/>
                                    </td>
                                    <td>
                                      <a>
                                        <xsl:attribute name="href">
        ...
        <xsl:choose>
          ...
          <xsl:when test="$char = 'M'">
            <xsl:choose>
              ...
              <xsl:when test="$pattern-length >= 3">
                <xsl:variable name="month-node" select="/date:months/date:month[number($month)]"/>
                <xsl:choose>
          ...
          <xsl:when test="$char = 'E'">
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:variable name="month-days" select="sum(/date:months/date:month[position() &lt; $month]/@length)"/>
                ...
                <xsl:variable name="day-node" select="/date:days/date:day[number($dow)]"/>
                <xsl:choose>
                  <xsl:when test="$pattern-length >= 4">
          ...
          <xsl:when test="$char = 'z'">
            <xsl:choose>
              ...
              <xsl:otherwise>
                UTC<xsl:value-of select="$timezone"/>
              </xsl:otherwise>
            </xsl:choose>
          </xsl:when>
          <xsl:otherwise>
        ...
        <tr>
          <td>
            <font color="#CCCCCC" size="3">
              <strong>
                Powered by the <a href="http://www.astm.org/cgi-bin/SoftCart.exe/DATABASE.CART/REDLINE_PAGES/E2369.htm?E+mystore" style="color:#CCCCCC;">ASTM E2369-05 Specification for the Continuity of Care Record (CCR)</a>
                <br/>
                <br/>
                Modified April, 2011 by <a href="http://www.medsphere.org" style="color:#CCCCCC;">Medsphere Systems</a> to include some extra information on Alerts, Test Results, Medications and Immunizations
              </strong>
            </font>
          </td>
        </tr>
