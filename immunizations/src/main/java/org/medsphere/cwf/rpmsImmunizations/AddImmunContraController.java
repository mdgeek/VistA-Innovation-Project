...
public class AddImmunContraController extends BgoBaseController<Object> {
	...
	public static void execute() {
		...
		AddImmunContraController controller = (AddImmunContraController) FrameworkController.getController(dlg);
		return;
	}
	...
	private void updateControls() {
		...
		btnSave.setDisabled(model.isSelectionEmpty() || 
				o == null || ((String) o).isEmpty());
    ...
    private boolean validate() {
    	Object o;
    	o = (String) txtVaccine.getAttribute("DATA");
    	if (o == null) {
    		PromptDialog.showWarning("You must first select the vaccine related to the contraindication.", "Specify Vaccine");
    		return false;
    	}
    ...
    private String toDAO() {
    	...
    	if (EncounterUtil.ensureEncounter(EF2)) {
    		appendData(sb, new FMDate(DateUtil.stripTime(EncounterContext.getActiveEncounter().getPeriod().getStart())).getFMDate());
    	}
    	return sb.toString();
    }
