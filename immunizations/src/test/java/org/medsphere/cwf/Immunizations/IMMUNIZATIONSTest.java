 ...
 */
package org.medsphere.cwf.Immunizations;
...
/**
 * Unit tests for Immunizations
 */
public class IMMUNIZATIONSTest extends CommonTest {
    
    private static final Log log = LogFactory.getLog(IMMUNIZATIONSTest.class);
